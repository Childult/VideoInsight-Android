...
Java_com_example_tygx_snpe_OCRPredictorNative_init(
...
Java_com_example_tygx_snpe_OCRPredictorNative_forward(
...
Java_com_example_tygx_snpe_OCRPredictorNative_release(
