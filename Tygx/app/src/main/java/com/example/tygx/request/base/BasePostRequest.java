package com.example.tygx.request.base;

import com.example.tygx.utils.Http;
...
public class BasePostRequest {
    ...
    public void sendJson() {
        Http.sendHttpPostRequestJson(this.url, this.json, this.callback);
    }
}
